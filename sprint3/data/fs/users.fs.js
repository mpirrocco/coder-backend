...
// users.create('Mario Pirrocco', 'no image', 'mario@mail.com')
// .then(res => users.create('Andrea deSouza', 'no image', 'andrea@mail.com'))
// .then(res => users.create('Ramón Cardozo', 'no image', 'ramon@mail.com'))

// users.read().then(res => console.log(res))
// users.readOne(3).then(res => console.log(res))
// users.deleteUser(2).then(res => console.log(res))